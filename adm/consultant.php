...
$ed= "conED.php?id=";
			...
			$stt.=$row['id'];
                    ...
                    $state='<td style="color:green;">مؤكد</td>' ;
                            ...
                            $tool='<a  href="'.$stt.'" data-toggle="modal" class="btn btn-primary btn-sm btn-flat" style="background-color: #2471A3 ; border-color: #2471A3;"><i class="fa fa-check"></i> تأكيد </a>';
