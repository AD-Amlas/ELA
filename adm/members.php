  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
           <a href="#addnew2" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> جديد</a>
              ...
              <table id="example1" class="table table-bordered">
                <thead>
                  ...
                  <th class="text-right" >التخصص</th>
                   ...
                   <th class="text-right" >العضوية</th>
...
$ed= "memE.php?id=";
			...
			$del.=$row['id'];
			   ...
			   if($row['type']==1){
                    ...
                    $type='<td style="color:blue;">طالب</td>' ;
                    ...
                    $state='<td style="color:green;">فعال</td>' ;
